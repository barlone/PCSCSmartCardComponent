...
begin
if pcsc.ConnectCard then memo1.lines.add('CONNECT to ''' + IntToStr(pcsc.ActiveReaderIndex) + ''' : OK')
                else memo1.lines.add('CONNECT to ''' + IntToStr(pcsc.ActiveReaderIndex) + ''' : NOT OK');
end;
